                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <div class="categories-item">
                                        <a href="pisici.php?subcat=Hrană uscată pisici" class="text-dark">Hrană uscată pentru pisici</a>
                                        <span>(<?php echo numaraProduse($conn, 'Pisici', 'Hrană uscată pisici'); ?>)</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="categories-item">
                                        <a href="pisici.php?subcat=Hrană umedă pisici" class="text-dark">Hrană umedă pentru pisici</a>
                                        <span>(<?php echo numaraProduse($conn, 'Pisici', 'Hrană umedă pisici'); ?>)</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="categories-item">
                                        <a href="pisici.php?subcat=Snack-uri" class="text-dark">Snack-uri pentru pisici</a>
                                        <span>(<?php echo numaraProduse($conn, 'Pisici', 'Snack-uri'); ?>)</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="categories-item">
                                        <a href="pisici.php?subcat=Jucării" class="text-dark">Jucării pentru pisici</a>
                                        <span>(<?php echo numaraProduse($conn, 'Pisici', 'Jucării'); ?>)</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
